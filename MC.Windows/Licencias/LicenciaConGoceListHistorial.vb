...
Public Class LicenciaConGoceListHistorial
    ...
    Sub New()
        ...
        ControlesDevExpress.InitGridViewColumn(GridView1, "MES", "MESEVALUACION", 120, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ControlesDevExpress.InitGridViewColumn(GridView1, "ESTADO PAGO", "DESCRIPCIONESTADOPAGO", 120, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ...
        ControlesDevExpress.InitGridViewColumn(GridView1, "ESTADO LICENCIA", "ESTADO", 120, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)
    ...
    Private Sub RefrescarxSolicitud()
        Try
            ...
            bsLicencias.DataSource = LicenciaDAO.GetAllLicenciasConGoceHistorial(btnFechaInicial.EditValue, btnFechaFinal.EditValue, 1)
        ...
        End Try
    End Sub
    Private Sub RefrescarxRegistro()
        Try
            bsLicencias.DataSource = LicenciaDAO.GetAllLicenciasConGoceHistorial(btnFechaInicial.EditValue, btnFechaFinal.EditValue, 2)
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub

    Private Sub LicenciaListHistorial_Activated(sender As Object, e As EventArgs) Handles Me.Activated

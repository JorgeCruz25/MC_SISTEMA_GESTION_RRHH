...
Public Class IncidenteAccidenteList
    ...
    Sub New()
        ...
        With GridView1
            ...
            .Columns("EMPLEADONOMBRE1").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
    ...
    Private Sub Refrescar()
        Try
            ...
            bsIncidenteAccidente.DataSource = IncidenteAccidenteDAO.IncidenteAccidenteListAll()
    ...
    Private Sub IncidenteAccidenteList_Activated(sender As Object, e As EventArgs) Handles Me.Activated
    ...
    Private Sub btnEvaluar_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnEvaluar.ItemClick
        IncidenteAccidenteDAO.IdIncidenteAccidente = GridView1.GetFocusedRowCellValue("IDINCIDENTEACCIDENTE")
        IncidenteAccidenteDAO.Empleado = GridView1.GetFocusedRowCellValue("EMPLEADONOMBRE1")
        Dim MiForm As New IncidenteAccidenteDetails
        MiForm.ShowDialog()
        Refrescar()
    End Sub
    ...
    Private Sub btnExportar_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnExportar.ItemClick
        If GridView1.RowCount > 0 Then
            Try
                Dim ruta As String
                ruta = My.Application.Info.DirectoryPath() + "\IncidentesAccidentes.xlsx"

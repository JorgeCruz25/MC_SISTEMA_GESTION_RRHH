...
Public Class InformeGeneralList
    Dim bsInformesGenerales As New BindingSource
    Sub New()
        InitializeComponent()
        ...
        End With
        Me.GridControl1.DataSource = bsInformesGenerales
        Refrescar()
    End Sub
    ...
    Private Sub Refrescar()
        Try
            ...
            bsInformesGenerales.DataSource = InformeGeneralDAO.InformeGeneralListAll()
    ...
    Private Sub btnEvaluar_ItemClick(sender As Object, e As ItemClickEventArgs) Handles btnEvaluar.ItemClick
        InformeGeneralDAO.IdInformeGeneral = GridView1.GetFocusedRowCellValue("IDINFORMEGENERAL")
        Dim MiForm As New InformeGeneralDetails
        MiForm.ShowDialog()
        Refrescar()
    End Sub

...
Public Class IngresoPersonalEdit
    ...
    Sub New()
        ...
        ControlesDevExpress.InitGridViewColumn(RepositoryItemGridLookUpEditEmpleadoView, "N° DOCUMENTO", "NUMERODOCUMENTO", 180, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ...
        RepositoryItemGridLookUpEditEmpleado.DataSource = BDAccionPersonalDAO.GetEmpleadoPendientesAccionPersonalList()
        ...
        'DERECHO HABIENTES
        ControlesDevExpress.InitGridViewColumn(GridViewDerechoHabientes, "ID", "IDDERECHOHABIENTE", 100, False, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ControlesDevExpress.InitGridViewColumn(GridViewDerechoHabientes, "TIPO DERECHO HAB.", "TIPODERECHOHABIENTE", 100, False, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ...
        ControlesDevExpress.InitGridViewColumn(GridViewDerechoHabientes, "N° DOCUMENTO", "NUMERODOCUMENTO", 100, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ...
        CargarMonedaCts()
        CargarBancoPlanilla()
        CargarBancoPropiedadCuenta()
        CargarTipoCuentaAbono()
        CargarFormaPago()

        'CargarGradoSalarial()
        CargarTipoEmpleadoReingreso()
        CargarMonedaReingreso()
        CargarCargosReingreso()
        CargarLocalesReingreso()
        CargarRegimenSalarialReingreso()
        CargarTipoContratoReingreso()
        ...
        If BDAccionPersonalDAO.IdEmpleado = 0 Then
            ...
            sleBancoPropiedadCuenta.Visible = False
            lblBancoPropiedadCuenta.Visible = False
        Else
            RibbonPageGroupEmpleado.Visible = False
            btnRegistrarEmpleado.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
            XtraTabPageHijos.PageVisible = True

            sleLocal.Enabled = False
            sleCargo.Enabled = False
            'sleUbicacionFisica.Enabled = False
            sleTipoEmpleado.Enabled = False
            sleTipoContrato.Enabled = False
            'sleCategoriaEmpleado.Enabled = False
            deFechaIngresoCompania.Enabled = False
            deFechaIngresoCoorporacion.Enabled = False
            deFechaFinContrato.Enabled = False
            txtSueldo.Enabled = False
            sleMoneda.Enabled = False
            'sleRegimenSalarial.Enabled = False
            sleRegimenFiscalizable.Enabled = False
            'sleRegimenSalarial.Enabled = False
            'sleRegimenTipoRemuneracion.Enabled = False
            'sleEsquemaVacacional.Enabled = False
            'sleDireccionConfianza.Enabled = False

            'sleIncritoAfp.Enabled = False

            'sleTipoAfp.Enabled = False

            'txtCodigoSpp.Enabled = False

            'dtFechaIngresoAfp.Enabled = False

            'RboComisionMixtaSi.Enabled = False
            'RboComisionMixtaNo.Enabled = False

            sleTipoTrabajadorSunat.Enabled = False
            sleBancoPro.Enabled = False
            sleBancoEnvio.Enabled = False
            sleMonedaCts.Enabled = False
            txtNumeroCuentaCts.Enabled = False


            'LISTA DERECHO HABIENTES
            GridControl1.DataSource = BDAccionPersonalDAO.GetEmpleadoDerechoHabientesList(BDAccionPersonalDAO.IdEmpleado)
    ...
    End Sub
    'Private Sub CargarGradoSalarial()
    '    ControlesDevExpress.InitGridViewColumn(GridViewGradoSalarial, "ID", "GRADOSALARIALADRYAN", 80, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)
    '    ControlesDevExpress.InitGridViewColumn(GridViewGradoSalarial, "DESCRIPCION", "DESCRIPCION_GRADO_SALARIAL", 180, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)

    '    With GridViewGradoSalarial
    '        .Columns("DESCRIPCION_GRADO_SALARIAL").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
    '    End With

    '    sleGradoSalarial.Properties.DataSource = BDAccionPersonalDAO.GetGradoSalarialList(sleCargo.EditValue)
    '    sleGradoSalarial.Properties.DisplayMember = "DESCRIPCION_GRADO_SALARIAL"
    '    sleGradoSalarial.Properties.ValueMember = "GRADOSALARIALADRYAN"
    '    sleGradoSalarial.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup
    'End Sub
    ...
    '---------------------
    Private Sub CargarTipoEmpleadoReingreso()
        ControlesDevExpress.InitGridViewColumn(GridViewTipoEmpleadoReingreso, "ID", "CODIGOTIPOEMPLEADO", 100, False, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ControlesDevExpress.InitGridViewColumn(GridViewTipoEmpleadoReingreso, "TIPO EMPLEADO", "TIPOEMPLEADO", 180, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)

        With GridViewTipoEmpleadoReingreso
            .Columns("TIPOEMPLEADO").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        End With

        sleTipoEmpleadoReingreso.Properties.DataSource = BDAccionPersonalDAO.GetTipoEmpleadoList
        sleTipoEmpleadoReingreso.Properties.DisplayMember = "TIPOEMPLEADO"
        sleTipoEmpleadoReingreso.Properties.ValueMember = "CODIGOTIPOEMPLEADO"
        sleTipoEmpleadoReingreso.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup
    End Sub
    Private Sub CargarCargosReingreso()
        ControlesDevExpress.InitGridViewColumn(GridViewCargoReingreso, "ID", "IDCARGO", 80, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ControlesDevExpress.InitGridViewColumn(GridViewCargoReingreso, "CARGO", "DESCRIPCION", 180, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)

        With GridViewCargoReingreso
            .Columns("DESCRIPCION").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        End With

        sleCargoReingreso.Properties.DataSource = BDAccionPersonalDAO.GetCargoList
        sleCargoReingreso.Properties.DisplayMember = "DESCRIPCION"
        sleCargoReingreso.Properties.ValueMember = "IDCARGO"
        sleCargoReingreso.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup
    End Sub

    Private Sub CargarLocalesReingreso()
        ControlesDevExpress.InitGridLookUpEditSearch(sleLocalReingreso, BDAccionPersonalDAO.GetLocalList, "IDORGANIGRAMA", "NOMBRE")
        ControlesDevExpress.InitGridLookUpEditSearchColumns(sleLocalReingreso, "ID", "IDORGANIGRAMA", 100, False)
        ControlesDevExpress.InitGridLookUpEditSearchColumns(sleLocalReingreso, "RAZON COMERCIAL", "RAZONCOMERCIAL", 200, True)
        ControlesDevExpress.InitGridLookUpEditSearchColumns(sleLocalReingreso, "NOMBRE", "NOMBRE", 220, True)
        With GridViewLocal
            .Columns("RAZONCOMERCIAL").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
            .Columns("NOMBRE").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        End With
    ...
    Private Sub CargarRegimenSalarialReingreso()
        ControlesDevExpress.InitGridViewColumn(GridViewRegimenSalarialReingreso, "ID", "IDREGIMEN", 100, False, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ControlesDevExpress.InitGridViewColumn(GridViewRegimenSalarialReingreso, "DESCRIPCION", "DESCRIPCION", 180, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)

        With GridViewRegimenSalarialReingreso
            .Columns("DESCRIPCION").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        End With

        sleRegimenSalarialReingreso.Properties.DataSource = BDAccionPersonalDAO.GetRegimenSalarialList
        sleRegimenSalarialReingreso.Properties.DisplayMember = "DESCRIPCION"
        sleRegimenSalarialReingreso.Properties.ValueMember = "IDREGIMEN"
        sleRegimenSalarialReingreso.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup
    End Sub

    Private Sub CargarMonedaReingreso()
        ControlesDevExpress.InitGridViewColumn(GridViewSueldoMonedaReingreso, "ID", "CODIGO", 100, False, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ControlesDevExpress.InitGridViewColumn(GridViewSueldoMonedaReingreso, "DESCRIPCION", "DESCRIPCION", 180, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)

        With GridViewSueldoMonedaReingreso
            .Columns("DESCRIPCION").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        End With

        sleMonedaReingreso.Properties.DataSource = BDAccionPersonalDAO.GetMonedaList
        sleMonedaReingreso.Properties.DisplayMember = "DESCRIPCION"
        sleMonedaReingreso.Properties.ValueMember = "CODIGO"
        sleMonedaReingreso.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup
    End Sub
    Private Sub CargarTipoContratoReingreso()
        ControlesDevExpress.InitGridViewColumn(GridViewTipoContratoReingreso, "ID", "tipocontrato", 100, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ControlesDevExpress.InitGridViewColumn(GridViewTipoContratoReingreso, "DESCRIPCION", "descripcion", 180, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)

        With GridViewTipoContratoReingreso
            .Columns("descripcion").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        End With

        sleTipoContratoReingreso.Properties.DataSource = BDAccionPersonalDAO.GetTipoContratoList
        sleTipoContratoReingreso.Properties.DisplayMember = "descripcion"
        sleTipoContratoReingreso.Properties.ValueMember = "tipocontrato"
        sleTipoContratoReingreso.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup
    End Sub
    ...
    Private Sub CargarBancoPropiedadCuenta()
        ControlesDevExpress.InitGridViewColumn(GridViewBancoPropiedadCuenta, "ID", "CODIGO", 100, False, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        ControlesDevExpress.InitGridViewColumn(GridViewBancoPropiedadCuenta, "BANCO", "NOMBRE", 100, True, ControlesDevExpress.eGridViewFormato.Ninguno, False)
        With GridViewBancoPropiedadCuenta
            .Columns("NOMBRE").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        End With
        sleBancoPropiedadCuenta.Properties.DataSource = BDAccionPersonalDAO.GetBancoCtsList
        sleBancoPropiedadCuenta.Properties.DisplayMember = "NOMBRE"
        sleBancoPropiedadCuenta.Properties.ValueMember = "CODIGO"
        sleBancoPropiedadCuenta.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup
    End Sub
    ...
    Private Sub LoadEntidad()
        If BDAccionPersonalDAO.IdEmpleado <> 0 Then
            ...
            With EmpleadoBE
                ...
                sleBancoPropiedadCuenta.EditValue = .CODIGOBANCOABONOPROPIETARIO
    ...
    Private Function validarReingreso() As Boolean
        ...
        If deFechaReingreso.EditValue >= deFechaFinContratoReingreso.EditValue Then
            MessageBox.Show("La fecha de reingreso no puede ser mayor a la fecha final de contrato", "ADvertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Result = False
        End If
        ...
        If sleEstadoCivil.EditValue Is Nothing Or sleEstadoCivil.EditValue = 0 Then
            ...
            Result = False
        End If
        If sleLocalReingreso.EditValue Is Nothing Or sleLocalReingreso.EditValue = 0 Then
            DxErrorProvider1.SetError(sleLocalReingreso, "Dato obligatorio")
            Result = False
        End If
        If sleCargo.EditValue Is Nothing Then
            ...
            Result = False
        End If
        If sleTipoEmpleadoReingreso.EditValue Is Nothing Or sleTipoEmpleadoReingreso.EditValue = "" Then
            DxErrorProvider1.SetError(sleTipoEmpleadoReingreso, "Dato obligatorio")
            Result = False
        End If
        If sleTipoContratoReingreso.EditValue Is Nothing Then
            DxErrorProvider1.SetError(sleTipoContratoReingreso, "Dato obligatorio")
            Result = False
        End If
        If deFechaReingreso.EditValue Is Nothing Or deFechaReingreso.Text = "01/01/1900" Then
            DxErrorProvider1.SetError(deFechaReingreso, "Dato obligatorio")
            Result = False
        End If
        If txtSueldoReingreso.Text = "0.00" Or txtSueldoReingreso.Text = "" Then
            DxErrorProvider1.SetError(txtSueldoReingreso, "Dato obligatorio")
            Result = False
        End If
        If sleMonedaReingreso.EditValue Is Nothing Or sleMonedaReingreso.EditValue = "" Then
            DxErrorProvider1.SetError(sleMoneda, "Dato obligatorio")
            Result = False
        End If
        If sleRegimenSalarialReingreso.EditValue Is Nothing Or sleRegimenSalarialReingreso.EditValue = 0 Then
            DxErrorProvider1.SetError(sleRegimenSalarialReingreso, "Dato obligatorio")
            Result = False
        End If
        ...
        If Result = True Then
            ...
            dtEmpleadoAdryan = BDAccionPersonalDAO.GetEmpleadoCargarDatosAdicionales(sleTipoIdentidad.EditValue, sleCargo.EditValue, sleLocalReingreso.EditValue, sleDistrito.EditValue)
            ...
            With EmpleadoBE
                ...
                .IDORGANIGRAMA = sleLocalReingreso.EditValue
                .IDCARGO = sleCargoReingreso.EditValue
                .IDREGIMENSALARIAL = sleRegimenSalarialReingreso.EditValue
                .CODIGOTIPOEMPLEADO = sleTipoEmpleadoReingreso.EditValue
                .SUELDO = Convert.ToDouble(txtSueldoReingreso.Text)
                .SUELDOMONEDA = sleMonedaReingreso.EditValue
                .TIPOCONTRATO = sleTipoContratoReingreso.EditValue
                .FECHAINGRESOCOMPANIA = deFechaReingreso.Text
                .FECHAFINALCONTRATO = deFechaFinContratoReingreso.Text
    ...
    Private Function Validar() As Boolean
        ...
        If Result Then
            ...
            With EmpleadoBE
                ...
                .CODIGOBANCOABONOPROPIETARIO = sleBancoPropiedadCuenta.EditValue
                ...
                If sleBancoPropiedadCuenta.EditValue Is Nothing Then
                    .CODIGOBANCOABONOPROPIETARIO = ""
                Else
                    .CODIGOBANCOABONOPROPIETARIO = sleBancoPropiedadCuenta.EditValue
                End If
    ...
    Private Sub btnRegistrarEmpleado_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnRegistrarEmpleado.ItemClick
        ...
        'If txtTipoEmpleado.Text = "NUEVO" Then
        If activosAdryan = 0 And activosCentral = 0 Then
            If Me.Validar Then
                If MessageBox.Show("Desea registrar al personal?", "Registrar Personal", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                    ...
                    If ValidacionDni = 0 Then
                        ...
                        If BDAccionPersonalDAO.InsertaEmpleadoAdryan(EmpleadoBE, xUltimoNumeroContrato) Then
                            '   INSERTA MC_CENTRAL
                            If Not BDAccionPersonalDAO.InsertaIngresoPersonal(EmpleadoBE, xUltimoNumeroContrato, BDCentralDAO.UsuarioBE.IDUsuario) Then
                        ...
                        End If
                    Else
                        MessageBox.Show("El número de documento ya se encuentra asignado a otro trabajador", "Error de Registro")
                    End If

                End If
            End If
            'Else
            '    'REINGRESO EMPLEADOADRYAN
            '    If Me.validarReingreso Then

            '        If MessageBox.Show("Desea registrar el reingreso del personal?", "Registrar Personal", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            '            xUltimoNumeroContrato = RenovacionContratoDAO.GetObtenerUltimoContrato()
            '            If xUltimoNumeroContrato = "" Then
            '                MessageBox.Show("Problemas de Conexión", "Error de Conexión")
            '                Cursor = Cursors.Default
            ...
            '            End If
            '            'REGISTRO ADRYAN
            '            If BDAccionPersonalDAO.InsertaReingresoEmpleadoAdryan(EmpleadoBE, xUltimoNumeroContrato, 1) Then '1 = ES UN REINGRESO DESDE POSTULANTE, 2 = REINGRESO PERO DESDE CAMBIO DEFINITIVO
            '                'REGISTRO MC_CENTRAL
            '                If Not BDAccionPersonalDAO.InsertaReIngresoPersonal(EmpleadoBE, xUltimoNumeroContrato, BDCentralDAO.UsuarioBE.IDUsuario) Then
            '                    MessageBox.Show("Error al registrar el reingreso de empleado", "Error de Registro")
            '                    Cursor = Cursors.Default
            '                    Exit Sub
            '                Else
            '                    EMPLEADONOMBRE = EmpleadoBE.NOMBRES + " " + EmpleadoBE.APELLIDOPATERNO + " " + EmpleadoBE.APELLIDOMATERNO
            '                    MessageBox.Show("El Reingreso del empleado " & EMPLEADONOMBRE & "fue exitoso", "Reingreso Empleado")
            '                    Me.Close()
            '                End If
            ...
            'End If
        Else
            MessageBox.Show("Para poder procesar el ingreso del personal, el trabajador tiene que estar cesado", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        End If
    End Sub
    ...
    Private Sub btnGuardar_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnGuardar.ItemClick
        ...
        If Me.Validar() Then
            Dim ValidacionDni As String = BDAccionPersonalDAO.ObternerExistenciaDni(Convert.ToString(EmpleadoBE.IDEMPLEADO), Trim(txtNumeroIdentidad.Text))
            If ValidacionDni = 0 Then
                If MessageBox.Show("Desea modificar datos del personal?", "Modificar Personal", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                    Cursor = Cursors.WaitCursor
                    'ACTUALIZAR EMPLEADO ADRYAN
                    If BDAccionPersonalDAO.UpdateEmpleadoAdryan(EmpleadoBE) Then
                        'ACTUALIZA MC_CENTRAL
                        If BDAccionPersonalDAO.UpdateEmpleado(EmpleadoBE) Then
                            EMPLEADONOMBRE = EmpleadoBE.NOMBRES + " " + EmpleadoBE.APELLIDOPATERNO + " " + EmpleadoBE.APELLIDOMATERNO
                            MessageBox.Show("La información del empleado " & EMPLEADONOMBRE & "fue exitoso", "Actualización de Información")
                            Cursor = Cursors.Default
                            Me.Close()
                        Else
                            Cursor = Cursors.Default
                            MessageBox.Show("Error al modificar datos del personal", "Error de Registro")
                        End If
                    Else
                        Cursor = Cursors.Default
                        MessageBox.Show("Problemas de Conexión con el sistema Adryan", "Error de Conexión")
    ...
    Private Sub RepositoryItemButtonEditEditar_Click(sender As Object, e As EventArgs) Handles RepositoryItemButtonEditEditar.Click
        BDAccionPersonalDAO.IdDerechoHabiente = GridViewDerechoHabientes.GetFocusedRowCellValue("IDDERECHOHABIENTE")
        Dim MiForm As New EmpleadoListEditHijos
